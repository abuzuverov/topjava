...
INSERT INTO user_roles (role, user_id) SELECT 'ROLE_USER', id FROM users WHERE name = 'User2';
...
INSERT INTO meals (date_time, description, calories, user_id)
  SELECT TIMESTAMP '2018-06-30 10:00:00', 'Завтрак', 500, id FROM users WHERE name = 'User2';
INSERT INTO meals (date_time, description, calories, user_id)
  SELECT TIMESTAMP '2018-06-30 13:00:00', 'Обед', 1000, id FROM users WHERE name = 'User2';
INSERT INTO meals (date_time, description, calories, user_id)
  SELECT TIMESTAMP '2018-06-30 20:00:00', 'Ужин', 510, id FROM users WHERE name = 'User2';
